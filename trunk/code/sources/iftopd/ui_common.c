...
/*   when  RESOLUTION defined 2  ,then   1*RESOLUTION = 2,   5* RESOLUTION = 10 and  20*RESOLUTION = 40 seconds */
/* 2, 10 and 40 seconds
int history_divs[HISTORY_DIVISIONS] = {1, 5, 20} */;


/* added by mengxiaosheng@dnion.com  */
int history_divs[HISTORY_DIVISIONS] = {1, 5, 60};
